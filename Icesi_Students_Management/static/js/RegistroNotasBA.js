function agregarMateria() {
    ...
    nuevaMateriaDiv.innerHTML = `
        ...
        <br>
        <input type="text" id="nombreMateria${contador}" name="nombreMateria${contador}" required style="width: 70%;">
        <br>
        <label for="creditosMateria${contador}" style="margin-top: 5%;">Creditos de la materia:</label>
        <br>
        <input type="number" id="creditosMateria${contador}" name="creditosMateria${contador}" required min="0" step="1" style="width: 10%;">
        <br>
        <label for="estatusMateria${contador}" style="margin-top: 5%;">Estatus de la materia:</label>
        <br>
        <select id="estatusMateria${contador}" name="estatusMateria${contador}" required style="width: 70%;">
        ...
        <br>
        <input type="number" id="Nota${contador}" name="Nota${contador}" required min="0.0" max="5.0" step="0.1" style="width: 10%;">
        <br>
    `;
