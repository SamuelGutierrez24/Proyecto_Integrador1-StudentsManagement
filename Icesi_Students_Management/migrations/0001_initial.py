# Generated by Django 4.2.5 on 2023-11-13 23:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.IntegerField(choices=[(0, 'None'), (1, 'Actividad Bienestar'), (2, 'Actividad CREA')], default=0)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.IntegerField(choices=[(0, 'None'), (1, 'Administrador'), (2, 'Filantropia'), (3, 'Bienestar Universitario'), (4, 'Contabilidad'), (5, 'Director del programa'), (6, 'Usuario del CREA')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comprobantePago', models.FileField(blank=True, null=True, upload_to='uploads/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(auto_now=True)),
                ('activity', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='Icesi_Students_Management.actividad')),
                ('seguimiento', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='Icesi_Students_Management.seguimientobeca')),
            ],
        ),
        migrations.CreateModel(
            name='Alerta',
