# Generated by Django 4.2.5 on 2023-10-26 21:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(0, 'None'), (1, 'Actualizacion de informacion contabilidad'), (2, 'Actualizacion de informacion Bienestar Universitario'), (3, 'Actualizacion de informacion Director de programa'), (4, 'Actualización de actividades no academicas de un estudiante'), (5, 'Actualización de actividades del CREA')], default=0)),
