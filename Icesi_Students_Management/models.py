...
class Donante(models.Model):
    ...
    typeBecas = models.ForeignKey(
        Becas, on_delete=models.CASCADE, default=None)
...
class Materia(models.Model):
    ...
    balanceAcademicoID = models.ForeignKey(
        BalanceAcademico, on_delete=models.CASCADE, default=None)
...
class Status(models.Model):
    ...
    materiaID = models.ForeignKey(
        Materia, on_delete=models.CASCADE, default=None)
...
class Alerta(models.Model):
    ...
    type = models.IntegerField(
        default=Type_alert.NONE, choices=Type_alert.choices)
    description = models.TextField(blank=True)
...
class Consulta(models.Model):
    ...
    seguimientoCreaID = models.ForeignKey(
        SeguimientoCREA, on_delete=models.CASCADE, default=None)
...
class InformacionFinanciera(models.Model):
    ...
    financialNote = models.TextField(blank=True)
...
class SeguimientoBeca(models.Model):
    ...
    informacionFinancieraID = models.ForeignKey(
        InformacionFinanciera, on_delete=models.CASCADE, default=None)
    SeguimientoActividadesID = models.ForeignKey(
        SeguimientoActividades, on_delete=models.CASCADE, default=None)
    balanceAcademicoID = models.ForeignKey(
        BalanceAcademico, on_delete=models.CASCADE, default=None)
    userID = models.ForeignKey(User, on_delete=models.CASCADE, default=None)
    studentCode = models.ForeignKey(
