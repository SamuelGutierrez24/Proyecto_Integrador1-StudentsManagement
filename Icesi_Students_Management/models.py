...
class Carrera(models.Model):
    ...
    precioMatricula = models.DecimalField(
...
class AsistenciasActividad(models.Model):
    seguimientoID = models.ForeignKey(
        SeguimientoBeca, on_delete=models.CASCADE,)
...
class BalanceAcademico(models.Model):
    ...
    statusID = models.ForeignKey(
        Status, on_delete=models.CASCADE, default=None)
    materiaID = models.ForeignKey(
        Materia, on_delete=models.CASCADE, default=None)
    SeguimientoBecaID = models.ForeignKey(
        SeguimientoBeca, on_delete=models.CASCADE, default=None, null=True)
...
class Alerta(models.Model):
    ...
    type = models.IntegerField(
        default=Type_alert.NNULL, choices=Type_alert.choices)
    description = models.TextField(blank=True)
